...
globalkeys = awful.util.table.join(
    ...
    -- Standard program
    awful.key({ modkey,           }, "Return", function () awful.util.spawn("xterm -e fish") end),
    ...
    awful.key({ "Mod1", "Shift"    }, "s" ,   function () kbdcfg.switch() end),
    --volume
...
--awful.util.spawn_with_shell("kate")
